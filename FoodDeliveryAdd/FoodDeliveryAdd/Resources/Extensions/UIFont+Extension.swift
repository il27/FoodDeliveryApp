...
//  FoodDeliveryAdd
//
//  Created by Ильяс on 15.04.2024.
//
...
extension UIFont {
    enum Roboto {
        ...
        enum boldItralic {
            static func size(of size: CGFloat) -> UIFont {
                return UIFont(name: Constants.Roboto.boldItralic, size: size)!
            }
        }
        enum italic {
            static func size(of size: CGFloat) -> UIFont {
        ...
        enum mediumlItalic {
            static func size(of size: CGFloat) -> UIFont {
                return UIFont(name: Constants.Roboto.mediumlItalic, size: size)!
            }
        }
        enum regular {
            static func size(of size: CGFloat) -> UIFont {
